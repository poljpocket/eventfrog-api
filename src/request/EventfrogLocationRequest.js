...
/**
 * @typedef {Object} EventfrogLocationRequestOptions
 * @property {string|string[]} [id] - location-Ids
...
module.exports = class EventfrogLocationRequest extends EventfrogRequest {
    /**
